...
{\missionsubheading{Night Fighting.}  If either player opts for Night
  ...
  units except superheavy vehicles and gargantuan creatures have
  Stealth throughout Turn 1.}
...
{\missionsubheading{Maelstrom.}%
  At the start of each player turn, the active player does the
  following until it has as many tactical objectives in play as the
  current turn number: Roll a~D66 and consult your tactical objective
  table, attached at the end of this mission packet.  If that
  objective is already in play for you, has been achieved, or is
